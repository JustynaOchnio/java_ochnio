...
public class ContactCreationTests {
    ...
    public void testContactCreation() throws Exception {
        openNewAddressPage();
        fillContactForm("Justyna", "Ochnio", "test1", "test2", "test3", "888555", "test@test");
        fillBirthdayDate("10", "January", "1980");
        selectGroup();
    ...
    private void fillBirthdayDate(String day, String month, String year) {
    ...
    private void fillContactForm(String firstname, String lastname, String title, String company, String address, String phone, String email) {
